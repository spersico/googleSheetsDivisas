...
const COLUMNAS = "value_avg, value_sell, value_buy"
const MERCADO_DIVISA = {
  BLUE_DOLAR: '$.blue',
  BLUE_EURO: '$.blue_euro',
  OFICIAL: "$.oficial",
...
/**
* Retorna los valores de mercado Blue de Dolares.
* @customfunction
*/
function COTIZACION_DOLAR_BLUE() {
  return IMPORTJSONAPI(URL, MERCADO_DIVISA.BLUE_DOLAR, COLUMNAS)
}
/**
* Retorna los valores de mercado Blue de Euros.
* @customfunction
*/
function COTIZACION_EURO_BLUE() {
  return IMPORTJSONAPI(URL, MERCADO_DIVISA.BLUE_EURO, COLUMNAS)
}

/**
* Retorna los valores de mercado oficial de Dolares.
* @customfunction
*/
function COTIZACION_DOLAR_OFICIAL() {
  return IMPORTJSONAPI(URL, MERCADO_DIVISA.OFICIAL, COLUMNAS)
}

/**
* Retorna los valores de mercado oficial de Euros.
* @customfunction
*/
function COTIZACION_EURO_OFICIAL() {
  return IMPORTJSONAPI(URL, MERCADO_DIVISA.OFICIAL_EURO, COLUMNAS)
}

if (typeof exports !== "undefined") {
  exports.COTIZACION_DOLAR_BLUE = COTIZACION_DOLAR_BLUE;
  exports.COTIZACION_EURO_BLUE = COTIZACION_EURO_BLUE;
  exports.COTIZACION_DOLAR_OFICIAL = COTIZACION_DOLAR_OFICIAL;
  exports.COTIZACION_EURO_OFICIAL = COTIZACION_EURO_OFICIAL;
}
